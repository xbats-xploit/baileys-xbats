...
exports.convertLegacyButtons = void 0;
 ...
 */
const convertLegacyButtons = (message, mediaMessage) => {
    if (!('buttons' in message) && !('templateButtons' in message)) {
        return mediaMessage;
    }
    const buttons = message.buttons || message.templateButtons || [];
    ...
    return { buttonsMessage: index_js_1.proto.Message.ButtonsMessage.create(buttonsMessage) };
};
exports.convertLegacyButtons = convertLegacyButtons;
//# sourceMappingURL=messages-compat.js.map